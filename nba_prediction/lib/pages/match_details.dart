    ...
    return Column(
      ...
      children: [
        ...
        GridView.count(
          ...
          childAspectRatio: 3,
          children: [
            _buildStatItem('Field Goal %', '${stats.teamFieldGoalPct * 100} - ${stats.opponentFieldGoalPct * 100}'),
            _buildStatItem('3PT %', '${stats.teamThreePointPct * 100} - ${stats.opponentThreePointPct * 100}'),
            _buildStatItem('Free Throw %', '${stats.teamFreeThrowPct * 100} - ${stats.opponentFreeThrowPct * 100}'),
            ...
            _buildStatItem('Turnovers', '${stats.teamTurnovers} - ${stats.opponentTurnovers}'),
          ],
        ),
      ],
    );
